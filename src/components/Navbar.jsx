    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-navy/90 backdrop-blur-md border-b border-white/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-20 items-center">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            {user ? (
              <>
                <Link to="/dashboard" className="text-slate-300 hover:text-gold transition-colors flex items-center gap-2">
      ...
      {isOpen && (
        <div className="md:hidden bg-navy border-b border-white/10 p-4 space-y-4">
          ...
          {user ? (
            <>
              <Link to="/dashboard" className="block text-slate-300 py-2">Dashboard</Link>
