            ...
            {step === 1 && (
              <div className="space-y-8 animate-in slide-in-from-right-4 duration-500">
                <div className="space-y-4">
                  <h3 className="text-xl font-extrabold text-navy">Schedule Session</h3>
                  <div className="grid grid-cols-1 gap-4">
                    <div className="space-y-2">
                      ...
                      <input 
                        ...
                        className="w-full bg-slate-50 border border-slate-200 p-4 rounded-2xl font-bold text-navy focus:outline-none focus:ring-2 focus:ring-gold/20" 
                      />
                    </div>
                    <div className="space-y-2">
                      <label className="text-[10px] font-bold text-slate-400 uppercase tracking-widest ml-1">Time Slot</label>
                      <select 
                        value={formData.time}
                        onChange={(e) => setFormData({...formData, time: e.target.value})}
                        className="w-full bg-slate-50 border border-slate-200 p-4 rounded-2xl font-bold text-navy focus:outline-none focus:ring-2 focus:ring-gold/20 appearance-none cursor-pointer"
                      >
                ...
                <button 
                  ...
                  className="w-full btn-gold py-4 rounded-2xl flex items-center justify-center gap-3 font-bold text-lg disabled:opacity-50 shadow-lg"
                >
